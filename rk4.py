...
@njit
def rk4_backwards(func, y, y0, t0, tf, nt, neqns):
    """
    ...
    """
    # when done, change back to tf
    h = t0 / (2*(nt - 1)) # define step size h 
    ...
    for i in range(0, nt-1):
        ...
        # when done, change back to t[i]+h
        t[i+1] = t[i] - h
...
@njit
def rk4_forwards(func, y, y0, t0, tf, nt, neqns):
    """
